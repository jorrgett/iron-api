...
namespace App\Repositories\ServiceAligment;

use App\Models\ServiceAligment;
use App\Repositories\BaseInterface;


class ServiceAligmentRepository implements BaseInterface
{

    protected $model;
    protected $serviceAligment;

    /**
     * ServiceItem Repository constructor.
     * @param ServiceItem $serviceAligment
     */
    public function __construct(ServiceAligment $serviceAligment)
    {
        $this->model = $serviceAligment;
    }
